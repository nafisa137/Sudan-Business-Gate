...
const orgs = [
  {
    ...
    identity: "MEDEF positions itself not just as a lobby but as a movement with a social conscience. Its raison d'être — 'Agir ensemble pour une croissance responsable' — frames business success and the general interest (l'intérêt général) as inseparable.",
    distinction: "MEDEF is the social negotiating partner of French trade unions, sitting at the table for all national interprofessional agreements covering labour contracts, unemployment insurance, professional training, and pensions. This quasi-constitutional role in French social dialogue gives it a formal authority in labour law that equivalent bodies in the UK or US cannot claim.",
    lesson: "Social mandate + political mobilisation. A federation that claims a mandate to contribute to the common good — not merely defend members — gains a legitimacy that pure lobbying bodies cannot.",
  },
  {
    code: "DE",
    name: "DIHK",
    ...
    identity: "DIHK self-describes as 'the strong voice for over three million companies — regionally anchored, nationally present, internationally connected.' Its values are rooted in the Ehrenkaufmann concept: the idea that business success and ethical conduct are inherently linked, not in tension.",
    distinction: "DIHK is the only organisation in this peer group that is a public-law corporation (Körperschaft des öffentlichen Rechts), supervised by Germany's Federal Ministry for Economic Affairs. Membership is mandatory by law for most commercial businesses — making it structurally democratic in a way no voluntary business body can claim. General Assembly meetings are public, agendas published in advance, minutes published afterwards.",
    lesson: "Structural legitimacy beats reputational legitimacy. A chamber whose membership is legally mandated — and whose governance is radically transparent — commands a different quality of trust from government and investors than a voluntary lobby group.",
  },
  {
    code: "DE",
    name: "BDI",
    ...
    identity: "BDI's values centre on three pillars it believes define Germany's identity: Industrieland (industrial nation), Exportland (export-oriented economy), and Innovationsland (innovative country). Its mission is to ensure Germany remains all three simultaneously.",
    distinction: "BDI is grounded in the social market economy (Soziale Marktwirtschaft) — a distinctly German model that embraces market competition while insisting on a social framework. Unlike the more ideological US counterparts, BDI does not oppose regulation as a concept; it opposes inefficient, excessive, or poorly designed regulation. This technocratic nuance makes it uniquely credible with European regulators. BDI has made 'resilience' its organising concept for 2026: resilient supply chains, resilient energy policy, resilient regulatory frameworks.",
    lesson: "Technocratic credibility over ideological posture. A federation that distinguishes between bad regulation and regulation as such earns a seat at the drafting table — not just the protest table.",
  },
  {
    code: "GB",
    name: "BCC",
    ...
    identity: "The BCC's mission is explicitly derived from and in service of its member chambers — not the other way around. It describes itself as 'the only organisation that helps British businesses to build relationships on every level — locally, nationally, and internationally.' The BCC sees itself as infrastructure for business communities, not merely a lobbying body.",
    distinction: "The BCC has arguably the most diverse digital feature set of any peer organisation: ChamberCustoms (customs clearance), an AI Academy, a Trade Accelerator, a Diplomatic Advisory Hub, and CBAM carbon calculators for exporters. Its 51 accredited UK chambers and 75+ international market presence give it a genuinely grassroots reach that national lobbying bodies lack.",
    lesson: "Community infrastructure is a moat. An organisation that builds relationships and practical tools — not just advocacy — becomes indispensable to its members in a way that policy-only bodies never achieve.",
  },
  {
    code: "GB",
    name: "CBI",
    ...
    identity: "The CBI positions itself as 'the voice of business since 1965' and identifies its role as being 'the largest policy unit outside of Whitehall' — framing it as a quasi-governmental intelligence and analysis centre, not merely a lobby. Its tagline: 'Pro-business legislation doesn't happen by accident.'",
    distinction: "The CBI's values were explicitly co-created by its people through an internally democratic process. Its continued operation following a serious governance crisis in 2023 — and its recommitment to high-conduct standards through an updated Code of Conduct and Council for Integrity — gives its values statements a tested quality absent from organisations that have never faced such scrutiny.",
    lesson: "Crisis governance as credibility. A federation that publicly confronts institutional failure and emerges with reformed governance demonstrates an institutional maturity that no clean-record organisation can replicate.",
  },
  {
    code: "US",
    name: "NAM",
    ...
    identity: "NAM's self-description is striking: 'The NAM isn't just another trade association. It is your support system, your resource, your champion and your voice.' It describes itself explicitly as an 'extension of your team' — a service-oriented framing that positions NAM as operational infrastructure for manufacturers, not just a political voice.",
    distinction: "Despite including Fortune 100 giants, 90% of NAM's members are small and mid-size manufacturers. NAM explicitly celebrates this as 'the power of small' — the idea that large manufacturers lending their voice amplifies the concerns of small ones. The NAM Legal Center fights cases to the Supreme Court on behalf of manufacturers, reflecting a values commitment that rule of law and judicial accountability matter as much as legislative wins.",
    lesson: "Amplify the small through the large. A federation that uses its heavyweight members as loudspeakers for SME concerns — rather than the reverse — builds a populist credibility that elite-only organisations cannot achieve.",
  },
  {
    code: "US",
    name: "BRT",
    ...
    identity: "BRT is an association of more than 200 chief executive officers of America's leading companies, collectively representing every sector of the US economy and supporting one in four American jobs. Policy positions are developed through CEO-led committees — meaning the most powerful executives in America personally engage in policy advocacy.",
    distinction: "In 2019, BRT fundamentally redefined corporate purpose. Since 1997 it had stated that corporations exist principally to serve shareholders. BRT explicitly superseded this with a new statement committing CEOs to five stakeholder groups — customers, employees, suppliers, communities, and shareholders, in that order. This was a landmark rejection of pure shareholder primacy by the most powerful business organisation in America. No other body in this peer group has made as sweeping or public a philosophical commitment to non-shareholder stakeholders.",
    lesson: "Redefine the purpose, not just the policy. The most durable institutional acts are philosophical — not lobbying wins, but public redefinitions of what business is for.",
  },
  {
    code: "US",
    name: "USCC",
...
{/* ── Hero ── */}
      <section className="sec sec-dark">
        <div className="eyebrow-light">Competitive intelligence</div>
        <h2 className="h2-light">
          How the world's leading<br />
          business federations are built.
        </h2>
        <p className="sub-light">
          A structured analysis of nine major employer and business
          organisations across France, Germany, the United Kingdom, and
          the United States — examining their structural models, core
          philosophies, and the design principles SBG can apply.
        </p>
        <div className="rec-meta-row">
          <div className="rec-meta-pill">9 organisations analysed</div>
          <div className="rec-meta-pill">4 countries</div>
          <div className="rec-meta-pill">5 strategic lessons</div>
        </div>
      </section>

      {/* ── Org cards ── */}
      <section className="sec sec-alt">
        <div className="eyebrow">Organisation profiles</div>
        <h2 className="h2">Unique values & philosophy</h2>
        <p className="sub">
          Each organisation was analysed directly from its about and values
          pages. What follows is what distinguishes each one — not just what
          it does, but what it believes.
        </p>

        <div className="rec-org-grid">
          {orgs.map((org) => (
            <div className="rec-org-card" key={org.name}>
              <div className="rec-org-header">
                <div className="rec-country-badge">{org.code}</div>
                <div>
                  <div className="rec-org-name">{org.name}</div>
                  <div className="rec-org-full">{org.full}</div>
                </div>
              </div>
              <div className="rec-org-subtitle">{org.subtitle}</div>

              <div className="rec-section-label">Core identity</div>
              <p className="rec-body">{org.identity}</p>

              <div className="rec-section-label">What makes it distinctive</div>
              <p className="rec-body">{org.distinction}</p>

              <div className="rec-lesson-box">
                <span className="rec-lesson-label">SBG lesson</span>
                <p className="rec-lesson-text">{org.lesson}</p>
              </div>
      ...
      <section className="sec">
        <div className="eyebrow">Strategic insights</div>
        <h2 className="h2">
          Five lessons for SBG<br />from the global landscape.
        </h2>
        <p className="sub">
        ...
        <div className="rec-insight-list">
          {insights.map((ins) => (
            <div className="rec-insight-row" key={ins.num}>
              <div className="rec-insight-num">{ins.num}</div>
      ...
      <section className="sec sec-dark">
        <div className="eyebrow-light">Structural models</div>
        <h2 className="h2-light">Two very different traditions.</h2>
        <p className="sub-light">
        ...
        <div className="grid-2 rec-compare-grid">
          <div className="rec-compare-card">
            <div className="rec-compare-region">European model</div>
            <div className="rec-compare-title">Structural authority</div>
          ...
          <div className="rec-compare-card">
            <div className="rec-compare-region">American model</div>
            <div className="rec-compare-title">Democratic authority</div>
            <p className="rec-body-light">
        ...
        <div className="rec-gap-box">
          <div className="rec-gap-label">The global gap — and SBG's opportunity</div>
          <p className="rec-body-light">
